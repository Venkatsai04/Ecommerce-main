...
const Product = () => {
  ...
  const mrp =
    productData.mrp && Number(productData.mrp) > price
      ? Number(productData.mrp)
      : Math.round(price * 2); // fallback if MRP not present
          ...
          <div className="mt-6 border-t pt-5">
            ...
            <div className="mt-8 border-t pt-6">
              ...
              <p className="text-gray-700 text-sm">
                ...
                This item is <span className="font-bold">not eligible for 
                  <span onClick={()=>{navigate('/returns')}}> <a className="text-blue underline"> returns</a> </span>
                  </span>.
              </p>
