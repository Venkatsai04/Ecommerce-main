      ...
      <div>
        {cartData.map((item, index) => {
          ...
          return (
            <div
              key={index}
              className='grid py-4 text-gray-700 border-t border-b grid-cols-[4fr_0.5fr_0.5fr]
              sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4'
            >
              <div className='flex items-start gap-6'>
                <img
                  className='w-16 sm:w-20'
                  src={productData?.image?.[0] ? productData.image[0] : assets.placeholder_img}
                  alt={productData?.name || "Photo"}
                />
                <div>
