        ...
        <div className="col-span-2">
          <div className="space-y-4">
            ...
            <div className="border-t pt-4 space-y-3">
              <p className="text-gray-700 cursor-pointer hover:text-black">🛒 My Orders</p>
              <p className="text-gray-700 cursor-pointer hover:text-black">📦 Returns</p>
              <p className="text-gray-700 cursor-pointer hover:text-black">⚙️ Settings</p>
            </div>
          </div>
        </div>
      </div>
