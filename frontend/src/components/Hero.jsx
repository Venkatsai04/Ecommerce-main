...
const Hero = () => {
  return (
    <div className='flex flex-col border border-gray-400 sm:flex-row'>
        ...
        <div className='flex items-center justify-center w-full py-10 sm:w-1/2 sm:py-0'>
            <div className='text-[#414141]'>
                <div className='flex items-center gap-2'>
                    ...
                    <p className='text-sm font-medium md:text-base'>OUR BEST <span className='text-yellow-300'>DIWALI</span> COLLECTION</p>
                </div>
        ...
        {/* Hero right side */}
        <img className='w-full sm:w-1/2' src={assets.hero_diwali} alt="Hero Image" />
    </div>
  )
}
